...
|:-----|:------------------------|:---------------|
| **Artificial Intelligence (AI)** | Software that can perform tasks typically requiring human judgment | Umbrella term; specificity matters for governance |
...
| **Fine-tuning** | Customizing a general AI model for a specific purpose | Relevant when vendors claim "bespoke" solutions |
...
| **Shadow AI** | Unauthorized AI use by employees (personal ChatGPT accounts for work) | Common and often invisible; policy and detection needed |
...
| **GPU/TPU** | Specialized computing hardware for AI | "What are the infrastructure costs?" |
