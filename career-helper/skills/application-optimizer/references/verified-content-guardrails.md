...
**Purpose:** Prevent hallucination, fabrication, and unverifiable embellishment when rewriting or optimizing a user's resume. Every word in a delivered resume must trace to a source the user has provided or confirmed.

**Applies to:** All resume and bullet-level output produced by application-optimizer. Research briefs and interview prep have their own citation rules (see `deep-research-reflection.md`).
...
- "Your award-winning...": verified award, or editorializing?
...
## Safe Optimization: What You Are Allowed to Do
...
**Safe:** Use A when the target role emphasizes global scale. Use B when the target role emphasizes team building. Both are verified.
...
- The job description emphasizes a skill or area that is adjacent to but not explicitly in the source material
- A metric in the source is outdated and you are unsure whether a newer number exists
- The source mentions a program or initiative by generic reference and a specific name would help the bullet land
