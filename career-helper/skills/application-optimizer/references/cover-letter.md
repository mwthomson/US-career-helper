...
**Purpose:** Draft a cover letter, supporting statement, or short application message that is specific, honest, and traceable to verified content. A cover letter earns its place by saying what the resume cannot: why this role, why this organization, and why now.

**Applies to:** All cover letter, supporting statement, and application message output produced by application-optimizer.
...
Motivation is the one area unique to a cover letter. Do not invent reasons the user cares about the organization. Ask them. "What specifically drew you to this role?" is a better question than guessing from the careers page.
...
3. **A research brief if one exists** (`applications/{role-slug}/research-brief.md`). Source for what is true about the organization. If none exists, offer to run Company Research first, or work from what the user can tell you.
4. **The user's own words on motivation.** Ask why this role and this organization matter to them. Do not supply the answer.
...
1. **The opening.** State the role you are applying for and one specific, genuine reason you are drawn to this organization. The reason must come from the user or the research brief, not from invention. Avoid generic flattery ("I have long admired your work"). Name something concrete.
...
4. **The close.** Why this organization specifically, tied to the user's own goals or values, and a short, confident call to action. No grovelling, no presumption.
...
- **Match the organization.** A charity, a bank, and a startup expect different registers. Use the research brief and the job description to calibrate. When in doubt, lean professional and warm rather than casual.
...
- **Career change or gap.** Frame the transition honestly and briefly. State the transferable evidence; do not over-explain or apologize.
